...
import core.SimClock;
 ...
 public class IntelligenceSprayAndWaitRouter extends ActiveRouter
{
    ...
    public IntelligenceSprayAndWaitRouter(Settings s)
    {
    ...
    protected IntelligenceSprayAndWaitRouter(IntelligenceSprayAndWaitRouter r)
    {
    	super(r);
    	initPreds();
	...
	{   	
		...
		IntelligenceSprayAndWaitRouter OtherRouter = (IntelligenceSprayAndWaitRouter)MRouter;
	...
	public void changedConnection(Connection con) 	
	{
		if (con.isUp())    
		{
			...
			IntelligenceSprayAndWaitRouter OtherRouter = (IntelligenceSprayAndWaitRouter)OtherHost.getRouter();
		...
		/* for all connected hosts collect all messages that have a higher
		   probability of delivery by the other host */
			...
			for (Connection con : getConnections()) 
			{
				...
				IntelligenceSprayAndWaitRouter othRouter = (IntelligenceSprayAndWaitRouter)other.getRouter();
	...
	public int compare(Tuple<Message, Connection> tuple1,
		...
		double p1 = ((IntelligenceSprayAndWaitRouter)tuple1.getValue().
				getOtherNode(getHost()).getRouter()).getUtilityFor
				(tuple1.getKey().getTo());
		// -"- tuple2...
		double p2 = ((IntelligenceSprayAndWaitRouter)tuple2.getValue().
				getOtherNode(getHost()).getRouter()).getUtilityFor
				(tuple2.getKey().getTo());
    ...
    public MessageRouter replicate() {
    	IntelligenceSprayAndWaitRouter r = new IntelligenceSprayAndWaitRouter(this);
		return r;
	}
}
